 ...
 */
public class DraftFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    @BindView(R.id.srl)
    ...
    @Subscribe
    public void onEvent(UpdateMailDraftEvent event) {
        onRefresh();
    }
    ...
    private void loadAccount() {
        ...
        mAdapter.setData(CacheService.getEmailsDraft());
    }
}
